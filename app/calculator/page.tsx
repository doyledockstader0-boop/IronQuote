      ...
      <header className="sticky top-0 z-50 bg-[#1C1F26] border-b border-[#2C3038]/40 backdrop-blur-sm shadow-lg">
        <div className="max-w-[1600px] mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button onClick={() => router.push('/summary')} className="flex items-center gap-2 px-4 py-2 bg-[#0A5CFF] text-white rounded-md text-sm font-semibold hover:bg-[#0951E6] transition-colors shadow-md">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
